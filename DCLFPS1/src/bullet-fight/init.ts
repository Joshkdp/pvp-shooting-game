...
//import { initbulletFightScene } from "src/bullet-fight/modules/scene/bulletArena";
...
export async function cacheUserData() {
  ...
  //initLobbyScene();
  //initRacingScene();
  //initbulletFightScene();

  //if to opt
  if (CONFIG.LOAD_MODELS_DURING_SCENE_LOAD_ENABLED) {
    /*Constants.SCENE_MGR.bulletArenaScene.init();
    ...
    Constants.SCENE_MGR.bulletArenaScene.hide(true);
