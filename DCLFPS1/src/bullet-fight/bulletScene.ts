...
import * as clientState from "src/bullet-fight/connection/state/client-state-spec";
...
export class bulletArena{
  ...
  blueLevelSpawnPoints:Vector3[] = [new Vector3(55,2,30), new Vector3(55,2,52), new Vector3(55,2,44), new Vector3(55,2,36), new Vector3(55,2,28),]
  redLevelSpawnPoints:Vector3[] = [new Vector3(120,2,50), new Vector3(120,2,52), new Vector3(120,2,44), new Vector3(120,2,36), new Vector3(120,2,28),]

  //death respawn points
  blueReSpawnPoints:Vector3[] = [new Vector3(55,2,30), new Vector3(55,2,52), new Vector3(55,2,44), new Vector3(55,2,36), new Vector3(55,2,28),]
  redReSpawnPoints:Vector3[] = [new Vector3(120,2,50), new Vector3(120,2,52), new Vector3(120,2,44), new Vector3(120,2,36), new Vector3(120,2,28),]
  ...
  initArena(force: boolean) {
    ...
    const roomName = CONFIG.GAME_bullet_ROOM_NAME
    joinOrCreateRoomAsync( roomName,connectOptions )

    //fps these now so have ability to quit
  ...
  onConnect(room: Room<clientState.BattleRoomState>) {
    ...
    //player.addBallManager( REGISTRY.SCENE_MGR.bulletArena.ballManager )
    //REGISTRY.SCENE_MGR.bulletArena.ballManager.room = room
  ...
  battleAboutToStart(){
    ...
    REGISTRY.SCENE_MGR.bulletArena.movePlayerToStartPointInArena()
  ...
  startBattle(){
    ...
    gameUI.DisplayCursorMessage('GAME STARTED!', 'Find and kill others!', 2)
    const canvas = new UICanvas()

    const aim1 = new UIImage(canvas, new Texture("textures/riffle.png"))

    aim1.sourceWidth = 870
    aim1.sourceHeight = 627
    aim1.width = "870px"; // Width of the displayed image (in pixels or percentage)
    aim1.height = "627px"; // Height of the displayed image (in pixels or percentage)
    aim1.positionX = "400px"; // X position of the image (in pixels or percentage)
    aim1.positionY = "-250px"; // Y position of the image (in pixels or percentage)
