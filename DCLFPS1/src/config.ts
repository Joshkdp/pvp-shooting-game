...
export class Config {
    ...
    GAME_bullet_ROOM_NAME = "bullet_room";
    ...
    DEBUGGING_TRIGGER_fpsAREA_ENABLED = false 
    DEBUGGING_TRIGGER_fpsAREA_DUMMY_OBJ_ENABLED = false
    ...
    TILE_RESPAWN_TIME = 10

    POWER_UP_RESPAWN_TIME = 60//3000

    ALLOW_FRIENDLY_FIRE = false
    
    bullet_AUTO_COLLECT_ENABLED = true //collect will happen when standing in area
    bullet_MAX_AMOUNT = 10
    bullet_COOLDOWN_SECONDS = .001
    bullet_POWERUP_DURATION_SECONDS = 30
