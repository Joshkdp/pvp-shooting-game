...
import { PlayerRankingsType } from 'src/bullet-fight/connection/state-data-utils'
import { teamColor } from 'src/modules/teamColors';
import { REGISTRY } from 'src/registry'
import { MenuButton } from 'src/bullet-fight/leaderboards/button'
import { Lobby } from 'src/bullet-fight/lobbyScene'
...
// export let Topfps2 = new UIContainerRect(TopScoresContainer)
// Topfps2.visible = true
// Topfps2.height = '75%'    
// Topfps2.hAlign = 'center'
// Topfps2.vAlign = 'center'
// Topfps2.width = '40%'
// Topfps2.positionY = 40
// Topfps2.color = Color4.FromHexString(`#ffffffff`)

// export let Topfps = new UIContainerRect(TopScoresContainer)
// Topfps.visible = true
// Topfps.height = '75%'    
// Topfps.hAlign = 'center'
// Topfps.vAlign = 'center'
// Topfps.width = '40%'
// Topfps.positionY = 34
// Topfps.color = Color4.FromHexString(`#ccccccff`)
...
// export let Ammofps = new UIContainerRect(BottomContainer)
// Ammofps.visible = true
// Ammofps.height = '12%'    
// Ammofps.hAlign = 'center'
// Ammofps.vAlign = 'bottom'
// Ammofps.width = '40%'
// Ammofps.positionY = 40
// Ammofps.color = Color4.FromHexString(`#ffffffff`)

// export let Ammofps2 = new UIContainerRect(BottomContainer)
// Ammofps2.visible = true
// Ammofps2.height = '12%'    
// Ammofps2.hAlign = 'center'
// Ammofps2.vAlign = 'bottom'
// Ammofps2.width = '40%'
// Ammofps2.positionY = 35
// Ammofps2.color = Color4.FromHexString(`#ccccccff`)
...
newAmmoContainerImage.positionX = -150 
...
AmmoText.positionX = -115
AmmoText.positionY = 0
...
let AmmoTextBARSlot 
for(let x = 0;x<10;x++){
  let AmmoTextBAR = new UIImage(AmmoContainer,CommonResources.RESOURCES.textures.bulletEmpty.texture)
  //AmmoTextBAR.
  setSection(AmmoTextBAR,CommonResources.RESOURCES.textures.bulletEmpty.size)
...
export function updateAmmo(_currentAmmo:number, _maxAmmo:number, _ammoPoweredUp:BallType[]){
  ...
  let str =""
  for(let x=0;x<CONFIG.bullet_MAX_AMOUNT;x++){
    ...
    if(t == 'normal'){
      //ui.value = "w"
      setSection(ui,CommonResources.RESOURCES.textures.bulletWhite.size)
    }else if(t=='yellow'){
      //ui.value = "y"
      setSection(ui,CommonResources.RESOURCES.textures.bulletYellow.size)
    }else{
      setSection(ui,CommonResources.RESOURCES.textures.bulletEmpty.size)
    }
  }
  //str += "<--"
...
export const bulletInstructionContainer = new UIContainerRect(ui.canvas)
bulletInstructionContainer.visible = true
bulletInstructionContainer.width = '22%'
bulletInstructionContainer.height = '6%'
bulletInstructionContainer.vAlign = 'bottom'
bulletInstructionContainer.hAlign = 'center'
bulletInstructionContainer.positionY = '12%'
bulletInstructionContainer.color = Color4.FromHexString(`#00000088`)

export const instructionMessage = new UIText(bulletInstructionContainer)
//set in displayMakebulletInstructions()
//instructionMessage.value = `Hold 'F' to make bullets\n`
...
export function displayMakebulletInstructions(display:boolean){
  let msg =  `In  reloading area\n`
  if(!CONFIG.bullet_AUTO_COLLECT_ENABLED){
    msg = `Hold 'F' to make bullets\n`
  }
  if(instructionMessage.value != msg){
    instructionMessage.value = msg
  }
  bulletInstructionContainer.visible = display
} 
//default false
displayMakebulletInstructions(false)
...
playQuitHudMenuButton.hAlign = "left"
playQuitHudMenuButton.positionX = 10// MENU_BOTTOM_POS_X
