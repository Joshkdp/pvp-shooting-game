...
//     }
//     this.items.winRed = new RewardItemContainer(this.container, base+(rowHeight*counter++), 5, "Win With Team A", makeImage(winningTeamRed),prefix+"team_wins_red"+postfix,winningTeamRed)
//     this.items.winBlue = new RewardItemContainer(this.container, base+(rowHeight*counter++), 5, "Win With Team B", makeImage(winningTeamBlue),prefix+"team_wins_blue"+postfix,winningTeamBlue)
