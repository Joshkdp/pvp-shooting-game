...
const BATTLE_STARTING_FONT_SIZE = 18;
const BATTLE_STARTING_ROW_2_Y = -5//-25;
const BATTLE_STARTING_ROW_3_Y = -30;
...
export function initLegacyUI(){
  ...
  */
  ...
  centerBattleStartingContainer.height = 100;
  ...
  battleStartingText.fontSize = 12;
  ...
  battleCountRedTeamLabel.value = "Team A";
  ...
  battleCountBlueTeamLabel.value = "Team B";
