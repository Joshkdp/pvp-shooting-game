...
export class AvatarAnimatorConfig{
  ...
  constructor(color : teamColor){
    ...
    {//Santa/Moonman
      ...
      this.throwClip = new AnimationState("bullet_Throw_UpperBody_Santa");
    }
    else
    {//Krampus
      ...
      this.throwClip = new AnimationState("bullet_Throw_UpperBody");
    }
...
export class BasePlayer {
  ...
  protected _throwAnimationDuration : number = CONFIG.bullet_COOLDOWN_SECONDS;//.35 tested value
