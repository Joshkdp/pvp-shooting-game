...
import { afterGameFormatPlayerName, getWinningTeam, sortPlayersByPosition, sortTeams } from 'src/bullet-fight/connection/state-data-utils';
...
import * as serverState from "src/bullet-fight/connection/state/server-state-spec";
...
const lineBreakTexture = CommonResources.RESOURCES.textures.bulletWhite.texture// new Texture("textures/road_orm.png")
//const lineBreakTexture = new Texture("textures/road_orm.png")
const defaultPlayerIcon = new Texture("textures/player.png")
...
const lineBreakTextureSource:any = {
                sourceHeight:20,sourceWidth:20, //want the white of the bullet
...
let instructions = "\nLobby\n is the area outside the area.  Here you can check scores and practice your bullet throwing technique. \n\nArena\nbullet fight!  Earn points for your team by freezing other players.  Highest score wins at the end wins.  \nMay the best team win! \n\nControls"
...
rowY-=rowHeight
rowY-=rowHeight
howToPlayPrompt.addText("Stand in fpsy areas to make bullets", 0,  rowY ,PROMPT_TITLE_COLOR,15)  
rowY-=rowHeight
howToPlayPrompt.addText("Aim + Click - Throws a bullet", 0,  rowY ,PROMPT_TITLE_COLOR,15)  
rowY-=rowHeight
