...
export async function createDebugUIButtons(){
  ...
  testButton = testControls.addButton(
    ...
    buttonPosY,
    () => { 
      REGISTRY.SCENE_MGR.bulletArena.resetBattleArena()
  ...
  testButton = testControls.addButton(
    ...
    buttonPosY,
    () => { 
      joinOrCreateRoom(CONFIG.GAME_bullet_ROOM_NAME)
    },
    ui.ButtonStyles.RED
  )
  updateDebugButtonUI(testButton)
...
buttonPosCounter += buttomWidth //next column
  ...
  testButton = testControls.addButton(
    ...
    buttonPosY,
    () => { 
      REGISTRY.SCENE_MGR.bulletArena.movePlayerToRespawnPointInArena()
    },
    ui.ButtonStyles.RED
  )
  updateDebugButtonUI(testButton)
  ...
  testButton = testControls.addButton(
    ...
    buttonPosY,
    () => { 
      REGISTRY.SCENE_MGR.bulletArena.initArena(true)
    },
    ui.ButtonStyles.RED
  )
  updateDebugButtonUI(testButton)
  ...
  testButton = testControls.addButton(
    ...
    buttonPosY,
    () => { 
      REGISTRY.SCENE_MGR.bulletArena.movePlayerHere(new Vector3(0,0,0),CONFIG.centerGround)
    },
    ui.ButtonStyles.RED
  )
  updateDebugButtonUI(testButton)
