...
const  customAtlasTexture = new Texture('textures/uisrc2.png' )
const newAtlasTexture = new Texture('textures/uisrc.png') //new Texture('textures/Atlases/atlas_v5.png')
...
export class CommonResources {
    static RESOURCES = {
        ...
        textures: {
          ...
          howToPlayTitle: {
            texture: new Texture ("textures/dlg_title.png"),
            size:{
              sourceHeight:211,sourceWidth:839,
              sourceTop:0,sourceLeft:0} //ImageSection
          },
          howToPlay1: {
            texture: new Texture("textures/dlg1.png"),
            size:{
              sourceHeight:989,sourceWidth:1330,
              sourceTop:0,sourceLeft:0} //ImageSection
          },
          howToPlay2: {
            texture: new Texture("textures/dlg2.png"),
            size:{
              sourceHeight:989,sourceWidth:1330,
              sourceTop:0,sourceLeft:0} //ImageSection
          }
